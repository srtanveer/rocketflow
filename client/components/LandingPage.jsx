...
export default function LandingPage() {
  ...
  // Use Corporate Office background for all sector cards
  const corporateBg = sectors.find(s => s.name === 'Corporate Office')?.color || 'bg-gradient-to-br from-blue-50 to-blue-100';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-blue-50 to-white text-gray-900 overflow-hidden">
      ...
      {/* Hero Section */}
      <Section className="min-h-screen flex items-center justify-center pt-16 sm:pt-16 pb-6 sm:pb-10" padding="sm">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-12 items-center">
            ...
            <div className="text-center sm:text-left flex flex-col justify-center px-4 sm:px-0">
              {/* Badge - Mobile Only */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-full mb-3 sm:mb-4 mx-auto sm:mx-0 w-fit">
                <span className="w-2 h-2 bg-blue-600 rounded-full animate-pulse"></span>
                <span className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] font-semibold text-blue-600">Welcome to RocketFlow</span>
              </div>
              ...
              <div className="mt-4 sm:mt-6 lg:mt-8 grid grid-cols-3 gap-2 sm:gap-3 lg:gap-4 bg-white sm:bg-transparent p-3 sm:p-0 rounded-2xl sm:rounded-none shadow-md sm:shadow-none border sm:border-0 border-blue-100">
                <div className="text-center sm:text-left">
                  <div className="text-[1.5rem] sm:text-[1.75rem] lg:text-[2rem] font-bold text-blue-600">635+</div>
                  <div className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] text-gray-600 mt-0.5 sm:mt-1">Active Users</div>
                </div>
                <div className="text-center sm:text-left border-l border-r sm:border-0 border-blue-100">
                  <div className="text-[1.5rem] sm:text-[1.75rem] lg:text-[2rem] font-bold text-blue-600">55+</div>
                  <div className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] text-gray-600 mt-0.5 sm:mt-1">Countries</div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-[1.5rem] sm:text-[1.75rem] lg:text-[2rem] font-bold text-blue-600">99.9%</div>
                  <div className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] text-gray-600 mt-0.5 sm:mt-1">Satisfaction</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-[320px] sm:h-[450px] lg:h-[600px] flex items-center justify-center lg:justify-start lg:pl-12 mt-6 sm:mt-8 lg:mt-0 overflow-visible">
                    ...
                    >
                      <div className={`bg-gradient-to-br from-white to-blue-50 rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-2xl p-3 sm:p-5 lg:p-8 w-52 sm:w-80 lg:w-96 border border-blue-100 sm:border-2 ${
                        ...
                        <div className="space-y-1.5 sm:space-y-2 lg:space-y-3 mb-2 sm:mb-3 lg:mb-4">
                          {dashboard.stats.map((stat, idx) => (
                            <div key={idx} className="flex items-center justify-between">
                              <span className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] text-gray-600">{stat.label}</span>
                              <div className={`text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] font-bold bg-gradient-to-r ${stat.color} bg-clip-text text-transparent`}>
                                {stat.value}
                              </div>
                            </div>
                          ))}
                        ...
                        <div className="border-t border-gray-200 pt-2 sm:pt-3 lg:pt-4">
                          ...
                          <div className="text-[0.563rem] sm:text-[0.625rem] lg:text-[0.75rem] text-gray-500 text-center mt-1 sm:mt-2">Activity Trend</div>
                        </div>
                      </div>
                    </div>
                  );
              ...
              <div className="hidden sm:block absolute top-0 -right-35 w-40 bg-white rounded-2xl shadow-xl p-3 border border-blue-100 animate-float">
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <div className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] text-gray-500">Messages</div>
                    <div className="text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] font-bold text-gray-900">12.5K</div>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden sm:block absolute bottom-0 left-0 w-40 bg-white rounded-2xl shadow-xl p-3 border border-blue-100 animate-float animation-delay-2000">
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <div className="text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem] text-gray-500">Growth</div>
                    <div className="text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] font-bold text-gray-900">+45%</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Section className="py-12 sm:py-16 relative overflow-hidden" padding="md">
      ...
      <Section id="services" className="">
        <Container>
          <div className="text-center mb-6 sm:mb-8 lg:mb-10 px-4">
            <h2 className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] font-bold mb-4 sm:mb-6 text-gray-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
            ...
            >
              ...
              <h3 className="text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] font-bold mb-2 sm:mb-3 text-gray-900">Multi-Channel Marketing</h3>
              <p className="text-gray-600 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] leading-relaxed flex-grow">Automated campaigns across Facebook, Messenger, Instagram, SMS, and Email to reach your audience everywhere</p>
            </Card>
            ...
            >
              ...
              <h3 className="text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] font-bold mb-2 sm:mb-3 text-gray-900">Automated Workflows</h3>
              <p className="text-gray-600 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] leading-relaxed flex-grow">Pre-built workflows for growing followers, collecting emails, responding to comments, and sending automated DMs</p>
            </Card>
            ...
            >
              ...
              <h3 className="text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] font-bold mb-2 sm:mb-3 text-gray-900">Industry-Specific Solutions</h3>
              <p className="text-gray-600 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] leading-relaxed flex-grow">Customized marketing automation for 12+ industries including photography, education, hospitality, e-commerce, and more</p>
            </Card>
            ...
            >
              ...
              <h3 className="text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] font-bold mb-2 sm:mb-3 text-gray-900">Customer Engagement</h3>
              <p className="text-gray-600 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] leading-relaxed flex-grow">Intelligent tools to boost engagement, request follows, collect leads, and convert audiences into valued customers</p>
            </Card>
          </div>
        </Container>
      </Section>
{/* Reach Your Audiences Section */}
      <Section id="channels" className="py-6 sm:py-8 lg:py-10">
        <Container>
          <div className="text-center mb-4 sm:mb-6 px-4">
            <h2 className="text-[1.5rem] sm:text-[1.75rem] lg:text-[2rem] font-bold mb-3 text-gray-900">
              <span className="text-blue-600">📡</span> Reach Your Audiences <span className="text-blue-600">With Ease</span>
            </h2>
            <p className="text-[1rem] sm:text-[1.125rem] lg:text-[1.25rem] text-gray-600 max-w-2xl mx-auto">
              Specialized tools to achieve <span className="text-blue-600 font-semibold">greater heights</span> for your business.
            </p>
          </div>

          {/* Channel Tabs */}
          <div className="flex flex-wrap justify-center gap-2 sm:gap-2.5 mb-4 sm:mb-6 px-4">
          ...
          {/* Channel Content */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 items-center max-w-5xl mx-auto px-4">
            ...
            <div className="order-1 md:order-2">
              <h3 className="text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] font-bold mb-2 sm:mb-3 text-gray-900">
                <span className="text-blue-600">»</span> {channels[activeChannel].title}
              </h3>
              <p className="text-gray-600 mb-3 sm:mb-4 leading-relaxed text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">
              ...
              <ul className="space-y-1.5 sm:space-y-2 mb-4 sm:mb-6">
                {channels[activeChannel].features.map((feature, index) => (
                  <li key={index} className="flex items-start gap-2">
                    ...
                    <span className="text-gray-600 text-[0.75rem] sm:text-[0.813rem] lg:text-[0.875rem]">{feature}</span>
                  </li>
                ))}
              </ul>
              <button className="w-full sm:w-auto px-4 sm:px-5 py-2 sm:py-2.5 bg-white text-blue-600 font-semibold flex items-center justify-center gap-2 transition-all text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] border-2 border-blue-600 rounded-lg hover:bg-blue-50 hover:shadow-md">
        ...
        <Container>
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="pl-0 md:pl-8 lg:pl-12">
              <h2 className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] font-bold mb-6 text-gray-900">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Highly Interactive</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Human-like Conversation</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Increase Engagement</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Increase Sales</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Automate Customer Support</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Collect Leads</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Sell Products</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Automate Restaurant Food Order</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Setup Chatbots Available 24/7</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 text-xl">✓</span>
                  <span className="text-gray-700 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">Never Miss a Single Message</span>
                </div>
              </div>
            </div>
      ...
      <Section id="industries" className="">
        <Container>
          <div className="text-center mb-6 sm:mb-8 lg:mb-10 px-4">
            <h2 className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] font-bold mb-3 sm:mb-4 text-gray-900">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2 sm:gap-3 lg:gap-4 px-4">
            {sectors.map((sector) => {
              ...
              const card = (
                <div className={`relative h-24 sm:h-auto p-4 sm:p-6 rounded-xl sm:rounded-2xl ${corporateBg} shadow-md border border-gray-200 transition-all duration-300 hover:scale-105 sm:hover:scale-110 hover:shadow-lg cursor-pointer flex items-center justify-center`}>
      ...
      <Section className="pb-6 sm:pb-8">
        <Container>
          <div className="text-center mb-6 sm:mb-8 px-4">
            <h2 className="text-[1.5rem] sm:text-[1.75rem] lg:text-[2rem] font-bold mb-3 sm:mb-4 text-gray-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 px-4">
            {[
          ...
          <div className="text-center mt-6 sm:mt-8 sm:hidden">
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-md hover:shadow-lg flex items-center gap-2 mx-auto text-[0.875rem]"
            >
              {showAllFeatures ? (
                <>
      ...
      {/* CTA Section */}
      <Section className="pt-8 sm:pt-10 pb-16 sm:pb-20 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-center mb-6">
                  <button
                    ...
                    className="px-8 py-3 bg-white text-blue-600 font-bold border-2 border-blue-600 rounded-xl hover:bg-blue-50 transition-all shadow-md hover:shadow-lg flex items-center gap-2"
                  >
                    {showPricingTable ? 'Hide' : 'View'} Package Features
                    <span className="text-xl">{showPricingTable ? '↑' : '↓'}</span>
                  </button>
                </div>
                ...
                <div className="flex justify-center">
                  <a href="https://rocketflow.biz/create_account/selected_package" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white border-2 border-blue-600 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all font-bold shadow-lg hover:shadow-xl text-lg">
                      Get Started Now - 1 Week Free Trial
                    </Button>
                  </a>
                </div>
              </div>
      ...
      <Section className="">
        <Container>
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] font-bold mb-4 text-gray-900">
            ...
            <div>
              <div className="space-y-4">
                <details className="group bg-white border-2 border-blue-200 rounded-lg p-4 hover:border-blue-600 hover:shadow-md transition-all">
                  <summary className="font-semibold text-gray-900 cursor-pointer flex items-center gap-2 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">
              ...
              <div className="relative w-full max-w-sm">
                <div className="bg-gradient-to-br from-blue-100 via-white to-blue-50 rounded-3xl p-8 shadow-xl border-2 border-blue-200">
                  <div className="text-center">
                    ...
                    <h3 className="text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] font-bold text-gray-900 mb-2">Need More Help?</h3>
                    <p className="text-gray-600 text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem] mb-4">
                      Check out our comprehensive documentation and guides
                    </p>
                    <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all font-semibold shadow-md hover:shadow-lg text-[0.875rem] sm:text-[0.938rem] lg:text-[1rem]">
                      View Documentation
                    </button>
                  </div>
                </div>
...
>>>>>>> 4ea48f81e06436487bc8696e35348a2d01225d1e
