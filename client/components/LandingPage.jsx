            ...
            <div className="relative max-w-6xl mx-auto h-[600px] flex items-center justify-center">
              ...
              <div className="absolute top-[8%] left-[17%] z-10 group">
                <div className="relative">
                  ...
                  <div className="card-glow relative bg-white rounded-2xl p-5 shadow-xl border-2 border-blue-100">
              ...
              <div className="absolute top-[8%] left-1/2 transform -translate-x-1/2 z-10 group">
                <div className="relative">
                  ...
                  <div className="card-glow relative bg-white rounded-2xl p-5 shadow-xl border-2 border-gray-200">
              ...
              <div className="absolute top-[8%] right-[17%] z-10 group">
                <div className="relative">
                  ...
                  <div className="card-glow relative bg-white rounded-2xl p-5 shadow-xl border-2 border-pink-100">
              ...
              <div className="absolute top-[62%] right-[17%] z-10 group">
                <div className="relative">
                  ...
                  <div className="card-glow relative bg-white rounded-2xl p-5 shadow-xl border-2 border-red-100">
              ...
              <div className="absolute bottom-[8%] left-[35%] z-10 group">
                <div className="relative">
                  ...
                  <div className="card-glow relative bg-white rounded-2xl p-5 shadow-xl border-2 border-green-100">
      ...
      <Section id="services" className="">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <Card
              className="card-hover card-shimmer group relative h-full flex flex-col"
              onMouseEnter={() => setHoveredService('multi-channel')}
              onMouseLeave={() => setHoveredService(null)}
              padding="lg"
            >
              <div className="relative z-10">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-lg bg-blue-600 flex items-center justify-center text-white mb-3 sm:mb-4">
            ...
            >
              <div className="relative z-10">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-lg bg-gray-800 flex items-center justify-center text-white mb-3 sm:mb-4">
              ...
              >
                {sector.name === 'Education' ? (
                  <a href="/education" className="block">
                    <div className={`relative h-24 sm:h-auto p-4 sm:p-5 lg:p-6 rounded-xl sm:rounded-2xl ${sector.color} shadow-md border border-gray-200 hover:shadow-lg cursor-pointer flex items-center justify-center`}>
                  ...
                  <a href="/study-abroad" className="block">
                    <div className={`relative h-24 sm:h-auto p-4 sm:p-6 rounded-xl sm:rounded-2xl ${sector.color} shadow-md border border-gray-200 hover:shadow-lg cursor-pointer flex items-center justify-center`}>
                      <div className="text-center">
                  ...
                  <a href="/hotel-and-resort" className="block">
                    <div className={`card-hover relative h-24 sm:h-auto p-4 sm:p-6 rounded-xl sm:rounded-2xl ${sector.color} shadow-md border border-gray-200 hover:shadow-lg cursor-pointer flex items-center justify-center`}>
                      <div className="text-center">
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 px-4">
            {[
              ...
              <div
                key={index}
                className="card-hover group relative bg-white border-2 border-blue-100 rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 hover:border-blue-600 hover:shadow-xl cursor-pointer"
              >
                <div className="flex items-start gap-2 sm:gap-3 lg:gap-4">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center flex-shrink-0 shadow-lg">
